...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/Cellar/ffmpeg/2.5.3 --enable-shared --enable-pthreads --enable-gpl --enable-version3 --enable-hardcoded-tables --enable-avresample --cc=clang --host-cflags= --host-ldflags= --enable-libx264 --enable-libmp3lame --enable-libvo-aacenc --enable-libxvid --enable-libfaac --enable-nonfree --enable-vda"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/usr/local/Cellar/ffmpeg/2.5.3/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/Cellar/ffmpeg/2.5.3/share/ffmpeg"
